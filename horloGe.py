...
afficher_horloge = Label(clock_tab,fg='blue', font=("arial", 80))
afficher_horloge.place(x=50, y=200)

clock_label = Label(clock_tab,fg='blue',font=("arial", 60, 'bold'), text = 'Horloge :')
clock_label.place(x=150, y=100)

boutton_24h = tk.Button(clock_tab,text="Format 24 heures",bd=10,bg="white", fg="blue",command=afficher_heure_24h,activeforeground="white",activebackground="blue",font="Andalus",height=2,highlightcolor="purple",justify="right",state = 'normal')
boutton_24h.place(x=50, y=470)

boutton_12h = tk.Button(clock_tab,text="Format 12 heures",bd=10,bg="white", fg="blue",command=afficher_heure_12h,activeforeground="white",activebackground="blue",font="Andalus",height=2,highlightcolor="purple",justify="right",state= 'disabled')
boutton_12h.place(x=250, y=470)

regler_heure_bouton = tk.Button(clock_tab,text="Régler l'heure",bd=10,bg="white", fg="blue",command=ouvrir_fenetre_reglage,activeforeground="white",activebackground="blue",font="Andalus",height=2,highlightcolor="purple",justify="right",state= 'normal')
